...
Классический рабочий стол: позволяет размещать иконки, файлы, корзину прямо на рабочем столе.
## Native Window Placement
Улучшает расположение окон в обзоре (Activities Overview): делает сетку более аккуратной и «естественной» по логике.
## Screenshot Window Sizer
Позволяет быстро изменять размеры окна для скриншотов. Полезно для аккуратного создания изображений интерфейсов.
## Ubuntu App Indicators
Поддержка классического системного трея. Нужна для множества приложений, использующих legacy-индикаторы.
## Ubuntu Dock
Док от Ubuntu — по сути Dash-to-Dock, но встроенный. Можно настроить поведение, автоскрытие, положение.
## Ubuntu Tiling Assistant
Продолжающаяся эволюция тайлинга в Ubuntu. Упрощает раскладку окон по сетке, быстрые комбинации, удобный snap-layout.